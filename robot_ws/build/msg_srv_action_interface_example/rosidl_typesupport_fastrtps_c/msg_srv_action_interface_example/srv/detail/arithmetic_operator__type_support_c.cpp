  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_srv_action_interface_example__srv__ArithmeticOperator_Request;
    is_plain =
      (
...
static size_t _ArithmeticOperator_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_action_interface_example__srv__ArithmeticOperator_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_srv_action_interface_example__srv__ArithmeticOperator_Response;
    is_plain =
      (
...
static size_t _ArithmeticOperator_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_srv_action_interface_example__srv__ArithmeticOperator_Response(
    full_bounded, is_plain, 0);
