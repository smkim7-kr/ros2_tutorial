...
{
  new (message_memory) msg_srv_action_interface_example::msg::ArithmeticArgument(_init);
}

void ArithmeticArgument_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_srv_action_interface_example::msg::ArithmeticArgument *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticArgument_message_member_array[3] = {
  {
    ...
    offsetof(msg_srv_action_interface_example::msg::ArithmeticArgument, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::msg::ArithmeticArgument, argument_a),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_example::msg::ArithmeticArgument, argument_b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticArgument_message_members = {
  "msg_srv_action_interface_example::msg",  // message namespace
  "ArithmeticArgument",  // message name
  3,  // number of fields
  sizeof(msg_srv_action_interface_example::msg::ArithmeticArgument),
...
{
  return &::msg_srv_action_interface_example::msg::rosidl_typesupport_introspection_cpp::ArithmeticArgument_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_srv_action_interface_example, msg, ArithmeticArgument)() {
  return &::msg_srv_action_interface_example::msg::rosidl_typesupport_introspection_cpp::ArithmeticArgument_message_type_support_handle;
}
