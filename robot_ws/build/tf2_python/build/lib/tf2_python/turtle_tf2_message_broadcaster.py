...
class PointPublisher(Node):
    ...
    def on_timer(self): # callback function
        if self.turtle_spawning_service_ready:
            ...
            if self.spawner.service_is_ready():
                ...
                request.x = 4.0 # init position for turtle3 = (4, 2, 0)
                request.y = 2.0
                request.theta = 0.0
                # Call request
        ...
        if self.turtle_pose_cansubscribe: # publish topics, subscribe pose
    ...
    def handle_turtle_pose(self, msg): # callback that runs when message is subscribed
        # publish messages turtle3/cmd_vel, turtle3/turtle_point_stamped
        vel_msg = Twist()
