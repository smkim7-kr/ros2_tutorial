...
: ${AMENT_CURRENT_PREFIX:="/robot_ws/install/tf2_cpp_"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf2_cpp_/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf2_cpp_/environment/path.sh"
