...
#ifndef MSG_SRV_ACTION_INTERFACE_EXAMPLE__SRV__DETAIL__ARITHMETIC_OPERATOR__FUNCTIONS_H_
#define MSG_SRV_ACTION_INTERFACE_EXAMPLE__SRV__DETAIL__ARITHMETIC_OPERATOR__FUNCTIONS_H_
 ...
 * calls
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Request__init().
...
/**
 * It calls
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Request__fini()
 ...
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_srv_action_interface_example
...
/**
 * It calls
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_srv_action_interface_example
...
/**
 * It allocates the memory for the array and calls
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_srv_action_interface_example
...
/**
 * It calls
 * msg_srv_action_interface_example__srv__ArithmeticOperator_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MSG_SRV_ACTION_INTERFACE_EXAMPLE__SRV__DETAIL__ARITHMETIC_OPERATOR__FUNCTIONS_H_
