...
bool msg_srv_action_interface_example__msg__arithmetic_argument__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_srv_action_interface_example.msg._arithmetic_argument.ArithmeticArgument", full_classname_dest, 76) == 0);
  }
  msg_srv_action_interface_example__msg__ArithmeticArgument * ros_message = _ros_message;
  {  // stamp
...
PyObject * msg_srv_action_interface_example__msg__arithmetic_argument__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_srv_action_interface_example.msg._arithmetic_argument");
